...
policy_session = None
action_scale = 2
default_positions = 'bl_shoulder_joint': 0.0,
            'bl_thigh_joint': 0.3,
            'bl_knee_joint': -0.75,
...
def process_policy_action(raw_actions):
    ...
    joint_position_dict = dict(zip([
        'bl_shoulder_joint', 'bl_thigh_joint', 'bl_knee_joint',
        'br_shoulder_joint', 'br_thigh_joint', 'br_knee_joint',
        'fl_shoulder_joint', 'fl_thigh_joint', 'fl_knee_joint',
        'fr_shoulder_joint', 'fr_thigh_joint', 'fr_knee_joint',
    ], default_positions))

    # Joint mapping with multipliers to account for mirror symmetry.
    joint_mapping = {
        0: ('bl_shoulder_joint', 1),
        1: ('bl_thigh_joint', 1),
        2: ('bl_knee_joint', 1),
        3: ('br_shoulder_joint', 1),
        4: ('br_thigh_joint', 1),
        5: ('br_knee_joint', 1),
        6: ('fl_shoulder_joint', 1),
        7: ('fl_thigh_joint', 1),
        8: ('fl_knee_joint', 1),
        9: ('fr_shoulder_joint', 1),
        10: ('fr_thigh_joint', 1),
        11: ('fr_knee_joint', 1),
    }
