...
class RewardsCfg:
    ...
    # === STABILITY REWARD ===
    upright_weight: float = 4.0               # Stay upright (uses projected gravity). Session 47/48 winning config.
    ...
    forward_motion_weight: float = 10.0       # EXP-702 config: 50/50 body/world hybrid at weight 10.
