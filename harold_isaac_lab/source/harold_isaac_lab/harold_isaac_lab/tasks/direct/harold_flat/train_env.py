...
def compute_rewards(env) -> torch.Tensor:
    ...
    # Velocity-gated: standing gets 50% height reward, stepping gets 100%
    velocity_gate = torch.clamp(vx_b / 0.1, min=0.5, max=1.0)
    stance_height = 4.0 * height_reward * velocity_gate
