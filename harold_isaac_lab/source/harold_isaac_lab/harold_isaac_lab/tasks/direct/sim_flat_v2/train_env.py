...
"""Mutable research surface for sim_flat_v2.

All 14 Spot flat locomotion reward terms, plus observations and action processing.
Identical to sim_flat_v1 — only the robot and body/joint patterns differ (in env.py).
"""
...
if TYPE_CHECKING:
    from .sim_flat_v2_env import SimFlatV2Env as SimFlatV1Env
