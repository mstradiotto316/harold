...
HAROLD_ROUGH_TERRAIN_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    curriculum=True,
    sub_terrains={
        # 40% flat — normal floor
        "flat": terrain_gen.MeshPlaneTerrainCfg(proportion=0.4),
        # 30% gentle rough (1-2cm) — carpet texture, floor irregularities
        ...
        # 15% moderate rough (2-4cm) — cable bumps, carpet edges, tile seams
        ...
        # 15% gentle slopes (5-10 degrees) — door thresholds, slight ramps
